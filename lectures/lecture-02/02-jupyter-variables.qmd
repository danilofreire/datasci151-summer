...
- There are two ways to create environments:
  - Using the command line: `conda create -n datasci151 python=3.12`
  - Using Anaconda Navigator: Go to the "Environments" tab and click on "Create"
- After creating an environment in the command line, you can activate it using the command line: `conda activate datasci151`
...
- To remove an environment, use the command line: `conda remove -n datasci151 --all`
:::
