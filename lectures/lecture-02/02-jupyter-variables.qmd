...
# Python environments {background-color="#1B3A6B"}
...
# Python packages 📦 {background-color="#1B3A6B"}
...
# Let's start coding: importing packages {background-color="#1B3A6B"}
...
# Running basic analyses {background-color="#1B3A6B"}
...
# Python variables & data types 📊 {background-color="#1B3A6B"}
...
# Python lists 📝 {background-color="#1B3A6B"}
...
# Visualising data with matplotlib 📊 {background-color="#1B3A6B"}
...
# Any questions? 🤔 {background-color="#1B3A6B"}

# And that's all for today! 🎉 {background-color="#1B3A6B"}

# Appendices: Solutions to exercises {background-color="#1B3A6B"}
