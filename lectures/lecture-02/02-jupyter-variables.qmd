...
:::{style="margin-top: 30px; font-size: 22px;"}
- As you have noticed, we will use [Visual Studio Code (VSCode)]{.alert} as our code editor
- It has excellent support for Jupyter Notebooks and integrates well with Anaconda environments

- **Ensure VSCode Uses Your Anaconda Python (Kernel Selection):**
  - When you open or create a `.ipynb` file in VSCode, it needs to know which Python installation (kernel) to use
