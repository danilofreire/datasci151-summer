...
# Welcome to another lecture! 😊 {background-color="#1B3A6B"}
...
# Vector arrays with NumPy 📊 {background-color="#1B3A6B"}
...
# Summary statistics 📊 {background-color="#1B3A6B"}
...
# Random numbers with Python 🎲 {background-color="#1B3A6B"}
...
# Boolean logic 🧠 {background-color="#1B3A6B"}
...
# Testing expressions with text 🐍 {background-color="#1B3A6B"} 
...
# Testing expressions with numbers 🐍 {background-color="#1B3A6B"}
...
# Testing multiple conditions 🐍 {background-color="#1B3A6B"}
...
# Thank you very much and see you next time! 🙏 {background-color="#1B3A6B"}
