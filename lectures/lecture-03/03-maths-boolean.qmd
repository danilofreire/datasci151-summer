...
format:
  clean-revealjs:
    ...
    footer: "[Maths with NumPy](https://danilofreire.github.io/datasci151-summer/lectures/lecture-04/04-maths-arrays-random.html)"
revealjs-plugins:
  - multimodal
transition: slide
...
# Welcome to another lecture! 😊 {background-color="#4338CA"}
...
# Vector arrays with NumPy 📊 {background-color="#4338CA"}
...
# Summary statistics 📊 {background-color="#4338CA"}
...
# Random numbers with Python 🎲 {background-color="#4338CA"}
...
# Boolean logic 🧠 {background-color="#4338CA"}
...
# Testing expressions with text 🐍 {background-color="#4338CA"} 
...
# Testing expressions with numbers 🐍 {background-color="#4338CA"}
...
# Testing multiple conditions 🐍 {background-color="#4338CA"}
...
# Thank you very much and see you next time! 🙏 {background-color="#4338CA"}
