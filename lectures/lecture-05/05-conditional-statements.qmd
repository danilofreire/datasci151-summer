...
# Today's class 📚 {background-color="#1B3A6B"}
...
# Flow control: conditional statements 🐍 {background-color="#1B3A6B"}
...
# Combining conditions and logical operators 🤓 {background-color="#1B3A6B"}
...
# Nested if statements 🪆 {background-color="#1B3A6B"}
...
# Conditional expressions (ternary operator) ✨ {background-color="#1B3A6B"}
...
# A bit more about lists in Python 📝 {background-color="#1B3A6B"}
...
# Lists with repetition 🔄 {background-color="#1B3A6B"}
...
# Appendix: solutions to exercises {background-color="#1B3A6B"}
