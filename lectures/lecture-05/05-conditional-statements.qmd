...
- Also called a "ternary operator" (three parts joined together)
...
:::{style="margin-top: 30px; font-size: 20px;"}
- You can create a list of [placeholder values]{.alert} using `None`
- A [truly empty list]{.alert} (zero elements) is just `[]`
- `None` is a special object that represents [the absence of a value]{.alert}
- It is often used as a placeholder, to be filled in later
...
- Let's see how to pre-fill a list with `None`:
...
[[Back to exercise]{.button}](#sec:lists)
:::