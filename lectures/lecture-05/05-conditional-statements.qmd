...
format:
  clean-revealjs:
    ...
    footer: "[Conditional Statements](https://danilofreire.github.io/datasci151-summer/lectures/lecture-05/05-conditional-statements.html)"
revealjs-plugins:
  - multimodal
transition: slide
...
# Today's class 📚 {background-color="#4338CA"}
...
# Flow control: conditional statements 🐍 {background-color="#4338CA"}
...
# Combining conditions and logical operators 🤓 {background-color="#4338CA"}
...
# Nested if statements 🪆 {background-color="#4338CA"}
...
# Conditional expressions (ternary operator) ✨ {background-color="#4338CA"}
...
# A bit more about lists in Python 📝 {background-color="#4338CA"}
...
# Lists with repetition 🔄 {background-color="#4338CA"}
...
# Questions? 🤔 {background-color="#4338CA"}
...
# Appendix: solutions to exercises {background-color="#4338CA"}
