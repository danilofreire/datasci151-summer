...
# I hope you're having a great day! 😊 {background-color="#1B3A6B"}
...
# Functions in Python 🐍 {background-color="#1B3A6B"}
...
# Custom functions in Python 🐍 {background-color="#1B3A6B"}
...
# Lambda functions  {background-color="#1B3A6B"}
...
# Understanding scope in Python 🧐 {background-color="#1B3A6B"}
