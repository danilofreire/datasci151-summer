...
format:
  clean-revealjs:
    ...
    footer: "[Functions](https://danilofreire.github.io/datasci151-summer/lectures/lecture-07/07-functions.html)"
revealjs-plugins:
  - multimodal
transition: slide
...
# I hope you're having a great day! 😊 {background-color="#4338CA"}
...
# Today's plan 📋 {background-color="#4338CA"}
...
# Functions in Python 🐍 {background-color="#4338CA"}
...
# Custom functions in Python 🐍 {background-color="#4338CA"}
...
# Lambda functions  {background-color="#4338CA"}
...
# Understanding scope in Python 🧐 {background-color="#4338CA"}
...
# Have a great day! 😊 {background-color="#4338CA"}
