...
- The [`return`]{.alert} statement is optional. Without it, the function returns `None`, so it's good practice to always return something
:::
:::
:::
...
:::{.columns}
:::{.column width="50%"}
- To change a global variable inside a function, use the [`global`]{.alert} keyword
...
[[Back to the example]{.button}](#sec:interest)
:::
