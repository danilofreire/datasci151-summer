...
:::{.columns}
:::{.column width="50%"}
- If you want to change a global variable inside a function, you need to use the [`global`]{.alert} keyword
...
- Sometimes, you might define a function *inside* another function. This is called a [nested function]{.alert} (we've spoken about this before!)
