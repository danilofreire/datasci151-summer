...
# Welcome to DATASCI 151! 🥳 {background-color="#1B3A6B"}
...
# Why Python and SQL? 🐍🗄️ {background-color="#1B3A6B"}
...
# Course logistics 📚 {background-color="#1B3A6B"}
...
# Computing set up 🖥️ {background-color="#1B3A6B"}
...
# Jupyter Notebooks 📘 {background-color="#1B3A6B"}
...
# Thank you very much for your attention! 🙏🎉 {background-color="#1B3A6B"}
