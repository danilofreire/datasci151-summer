...
# Welcome to DATASCI 151! 🥳 {background-color="#4338CA"}
...
- This course is hosted on [GitHub](https://github.com), where you will find the [syllabus, lecture materials, tutorials, and assignments]{.alert}. You can download the materials and follow along with the lectures using Jupyter Notebooks or the lecture notes
- Canvas will be used for course management, including [assignment submissions, grades, and announcements]{.alert}. Please familiarise yourself with both platforms, and reach out if you have any questions
...
# Nice to meet you! 👋 {background-color="#4338CA"}
...
# Why Python and SQL? 🐍🗄️ {background-color="#4338CA"}
...
# Course logistics 📚 {background-color="#4338CA"}

## Course objectives

:::{.incremental}
1. Perform basic operations and write functions in Python
2. Use Jupyter Notebooks for reproducible research
...
5. Merge and manage databases using SQL
...
# Computing set up 🖥️ {background-color="#4338CA"}
...
# Git and GitHub 🐙{background-color="#4338CA"}
...
# Jupyter Notebooks 📘 {background-color="#4338CA"}
...
# Thank you very much for your attention! 🙏🎉 {background-color="#4338CA"}
