...
- Follow the instructions [Installing Visual Studio Code and Connecting it with Anaconda](https://github.com/danilofreire/datasci151-summer/blob/main/tutorials/01-vscode-anaconda-tutorial.pdf) from GitHub
...
- For now: know that ["base"]{.alert} is the Anaconda virtual environment that comes by default with the installation​
...
- Next step: we will create a new folder for the DATASCI 151 course and download our virtual GitHub folder and opening it in VSCode
:::
