...
connection = sqlite3.connect('lecture13.db'); cursor = connection.cursor()
...
- Here's how you can close the connection and delete the database file (`lecture13.db`) we used in this lecture using Python:
