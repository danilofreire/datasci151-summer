...
format:
  clean-revealjs:
    ...
    code-overflow: wrap
    footer: "[SQL Joins](https://danilofreire.github.io/datasci151-summer/lectures/lecture-13/13-sql-tables.html)"
transition: slide
...
- Before we get into joins, a quick request: please take a few minutes to [fill in the course evaluation]{.alert} 🤓
- Your feedback is important and shapes how I run this course next time!
- If there was anything you enjoyed about the class, or found the teaching helpful, please feel free to say so too 😊
- To find the form, open [Canvas]{.alert} and go to [Account → Profile → Course Evaluations]{.alert}
- If you have already filled it out, thank you so much! 🙏
:::

# Basic joins 📊 {background-color="#4338CA"}
...
## Connect to the database and create the tables {#sec:tables}
...
- [Requires SQLite 3.39.0 or newer]{.alert} (June 2022). The same goes for `FULL OUTER JOIN` on the next slide. On older versions you'd have to emulate them with `LEFT JOIN`
...
# Special joins 🌟 {background-color="#4338CA"}
...
# Merge tables by row 🧩 {background-color="#4338CA"}
...
# Conclusion 📖 {background-color="#4338CA"}
...
- That's a lot for one lecture! 🚀 The appendices have solutions to the 'Try it yourself!' exercises
:::

# And that's all for today! 🎉 {background-color="#4338CA"}

# Thank you and have a great rest of your day! 🙏 {background-color="#4338CA"}
