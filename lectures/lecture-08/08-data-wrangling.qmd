...
# Recap of last class 📚 {background-color="#1B3A6B"}
...
# Operations over many variables using Pandas 🐼 {background-color="#1B3A6B"}
...
# Importing modules 📦 {background-color="#1B3A6B"}
...
# Loading packages and dataset 📦 {background-color="#1B3A6B"}
...
# NaN values 🚫 {background-color="#1B3A6B"}
...
# Data cleaning 🧹🧽 {background-color="#1B3A6B"}
...
# Recoding numeric variables 🔄 {background-color="#1B3A6B"}
