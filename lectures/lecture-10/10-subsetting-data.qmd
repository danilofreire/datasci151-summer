...
- [Download the dataset](https://github.com/danilofreire/datasci151-summer/blob/main/lectures/lecture-10/data_raw/features.csv) if you don't have it (click on `Download Raw File`)
