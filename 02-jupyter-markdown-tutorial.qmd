...
in [this notebook](https://github.com/danilofreire/datasci151-summer/blob/main/tutorials/testing-ipython.ipynb). 
```
...
You can create equations using the `$$` symbol. For example, here is the formula for the standard deviation of a population:
...
You can include figures in your document using the `![Caption](path/to/image.png)` syntax. For example:

```{markdown}
![This is a figure caption.](path/to/image.png)
```

This will include the image `path/to/image.png` in your document with the caption "This is a figure caption."
