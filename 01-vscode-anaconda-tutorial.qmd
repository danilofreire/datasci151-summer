...
You should also install the [Jupyter](https://marketplace.visualstudio.com/items?itemName=ms-toolsai.jupyter) and the [Python](https://marketplace.visualstudio.com/items?itemName=ms-python.python) extensions for VS Code. These extensions will allow you to work with Jupyter notebooks and Python code directly in the editor.

To install the extensions, click on the Extensions view icon on the left sidebar (it looks like four squares) and search for "Jupyter" and "Python". Click "Install" for both extensions. Or just click on the links above to install them directly.
